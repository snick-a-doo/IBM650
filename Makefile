...
test_OBJ= computer.o register.o input_output_unit.o test_computer.o test_opcodes.cpp test_input_output.o test_register.o test.o
CXX= g++ -g -Wall
...
libIBM650.a: computer.o register.o input_output_unit.o
	ar ru $@ $^
	ranlib $@
